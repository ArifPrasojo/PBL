<?php 
  $menu = 't_responden_tendik'; 

  include_once('model/tendik_form_model.php');
...
<head>
  ...
  <title>Mahasiswa Responden</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Responden Tendik</a></li>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table class="table table-sm table-bordered">
            ...
            <tbody>
              <?php 
                $tendik_form_model = new tendik_form_model();
                $tendik_form_model = $tendik_form_model->getData();

                $i = 1;
                while($row = $tendik_form_model->fetch_assoc()){
                  echo '<tr>
                      <td>' . $i . '</td>
                      <td>'.$row['survey_id'].'</td>
                      ...
                      <td>
                      <a title="View" href="responden_ortu_form.php?act=view&id=' . $row['responden_tendik_id'] . '" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
