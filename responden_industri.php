...
<head>
  ...
  <title>Industri Responden</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Responden Industri</a></li>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table class="table table-sm table-bordered">
            ...
            <tbody>
              <?php 
                $industri_form_model = new industri_form_model();
                $industri_form_model = $industri_form_model->getData();

                $i = 1;
                while($row = $industri_form_model->fetch_assoc()){
                  echo '<tr>
                      <td>' . $i . '</td>
                      <td>'.$row['survey_id'].'</td>
                      ...
                      <td>
                      <a title="View" href="responden_ortu_form.php?act=view&id=' . $row['responden_industri_id'] . '" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
