    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Responden Mahasiswa</h3>
        </div>
        <div class="card-body">
          ...
          <table class="table table-sm table-bordered">
            ...
            <tbody>
              <?php 
                $mahasiswa_form_model = new mahasiswa_form_model();
                $mahasiswa_form_model = $mahasiswa_form_model->getData();

                $i = 1;
                while($row = $mahasiswa_form_model->fetch_assoc()){
                  echo '<tr>
                      <td>' . $i . '</td>
                      <td>'.$row['survey_id'].'</td>
                      ...
                      <td>
                        <a title="View" href="responden_ortu_form.php?act=view&id=' . $row['responden_mahasiswa_id'] . '" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
